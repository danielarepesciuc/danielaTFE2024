...
<template>
  <div
    ...
    <div
      class="h-full card-gradient flex p-[24px] md:p-[16px] flex-col justify-between items-start">
      <div class="space-y-4">
      ...
      <div class="flex flex-row pt-8 pb-2 gap-6 md:flex-col md:w-full items-start">
        <div class="CTA3 ">
